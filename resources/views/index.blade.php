                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0">{{ $totaljurusan1 }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    @empty
                                                    <tr>
                                                        <td colspan="2">No users found matching your search criteria.</td>
                                                    </tr>
                                                    @endforelse ($mahasiswas as $item)
